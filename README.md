...
This package installs the offical [CodeIgniter](https://github.com/bcit-ci/CodeIgniter) (version `3.1.*`) with *multiple applications project* in secure folder structure via Composer.
